...
namespace Utils {
    ...
    inline void drawOutlineBox(QPainter* painter, int x, int y, int width, int height) {
    ...
    inline void drawOutlineBox(QPainter* painter, int x, int y, int width, int height, const char* color) {
